...
public class QueryInputComplex extends JFrame {
	...
	// Constructor
	QueryInputComplex() throws SQLException, ClassNotFoundException {
		...
		qbc = new QueryBuilderComplex(this);
		
		qbc.setConsole();
		//qbc.getConsole();

		// For Table
		tb_condition.setModel(qbc.setTable());
	...
	void initComponents() throws ClassNotFoundException, SQLException {
		...
		lbl_column = new javax.swing.JLabel("Column Name");
		lbl_column.setFont(new Font("Cambria", Font.BOLD, 18));
		
		lbl_operator = new javax.swing.JLabel("Operator");
		...
		lbl_Type2 = new JLabel("TYPE 2 Query Builder");
		lbl_Type2.setFont(new Font("Cambria", Font.BOLD, 22));
		lbl_Type2.setBackground(new Color(255, 255, 255));
		...
		lbl_Type2.setBounds(w/2-w/16, h/18, w/8, 30);
		...
		picker_fromDate.setBounds(w/24+x+dist, h/8+20, 240, 40);
		x=x+w/11+dist;
		...
		picker_toDate.setBounds(w/24+x+dist, h/8+20, 240, 40);		
		...
		btn_back.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new Menu();
				QueryInputComplex.this.dispose();
			}
		});
		
		rdb_text.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				qbc.rdb_textStateChanged(arg0);
		...
		rdb_column.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				qbc.rdb_colopStateChanged(arg0);
